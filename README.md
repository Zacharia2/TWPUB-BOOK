...
supermemo导入电子书只适合纯文本书籍，TW有更好的更兼容的方式，所以我的渐进式阅读目标已经达成了，首先是找到自己想要渐进式阅读的电纸书epub。用TWPUB-Tools工具转换，然后拖放放进wiki，然后在墨屉设置（小齿轮）-信息选项卡-基本组重命名墨屉标题设置为：🦑墨屉+书名。然后放进onedrive即可进入同步。
